                    ...
                    <div class="col-xl-10">
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="page-header" id="top">
                                    <h2 class="pageheader-title">Form Insert Komponen </h2>
                                    ...
                                    <div class="page-breadcrumb">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item active" aria-current="page">Form Insert Komponen</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="card">
                                    <h5 class="card-header">Insert Komponen</h5>
                                    <div class="card-body">
                                        <div class="form-group">
                                            <table>
                                                <tr>
                                                    ...
                                                    <td>
                                                            <div>
                                                                    <select style="background-color: lightgray; color: black; height: 40px; width: 150px;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                            <div>
                                                                    <select style="background-color: lightgray; color: black; width: 109px; height: 30px;width: 50px; padding-left: 10px;">
