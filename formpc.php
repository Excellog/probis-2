      ...
      <div class="nav-left-sidebar sidebar-dark">
            <div class="menu-list">
                <nav class="navbar navbar-expand-lg navbar-light">
                    <a class="d-xl-none d-lg-none" href="#">Dash</a>
                        ...
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                ...
                                <div id="submenu-4" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="forms.php">Form Insert Komponen</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="formlaptop.php">Form Insert Product Laptop</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="formpc.php">Form Insert Product PC</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                    ...
                    <div class="col-xl-10">
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="page-header" id="top">
                                    <h2 class="pageheader-title">Form Insert Product PC </h2>
                                    ...
                                    <div class="page-breadcrumb">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item active" aria-current="page">Form Insert Product PC</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="card">
                                    <h5 class="card-header">Insert Product PC</h5>
                                    <div class="card-body">
                                        <div class="form-group">                                                                                       
                                            <table>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form_group">
                                                            <label class="custom-control custom-radio custom-control-inline">
                                                                <input type="radio" name="radio-inline" checked="" class="custom-control-input"><span class="custom-control-label">Gaming</span>
                                                            </label>
                                                            <label class="custom-control custom-radio custom-control-inline">
                                                                <input type="radio" name="radio-inline" checked="" class="custom-control-input"><span class="custom-control-label">Office</span>
                                                            </label>
                                                            <label class="custom-control custom-radio custom-control-inline">
                                                                <input type="radio" name="radio-inline" checked="" class="custom-control-input"><span class="custom-control-label">Design</span>
                                                            </label>
                                                        </div>
                                                    </td>
                                                </tr>						
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <?php
                                                            $query = mysqli_query($conn, "select id_barang,nama_barang from barang where kode_kategori = '5'");
                                                            ?>
                                                            <select style="background-color: lightgray; color: black; height: 40px; width: 650px;">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                        <div>
                                                        <?php
                                                            $query = mysqli_query($conn, "select id_barang,nama_barang from barang where kode_kategori = '2'");
                                                            ?>
                                                            <select style="background-color: lightgray; color: black; height: 40px; width: 650px;">
                                                            <?php while ($row = mysqli_fetch_array($query)) { ?>    
                                                                <option value="<?php echo $row["id_barang"]; ?>"><?php echo $row["nama_barang"]; ?></option>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div>
                                                    <?php
                                                            $query = mysqli_query($conn, "select id_barang,nama_barang from barang where kode_kategori = '4'");
                                                            ?>
                                                            <select style="background-color: lightgray; color: black; height: 40px; width: 650px;">
                                                            <?php while ($row = mysqli_fetch_array($query)) { ?>    
                                                                <option value="<?php echo $row["id_barang"]; ?>"><?php echo $row["nama_barang"]; ?></option>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div>
                                                    <?php
                                                            $query = mysqli_query($conn, "select id_barang,nama_barang from barang where kode_kategori = '1'");
                                                            ?>
                                                            <select style="background-color: lightgray; color: black; height: 40px; width: 650px;">
                                                            <?php while ($row = mysqli_fetch_array($query)) { ?>    
                                                                <option value="<?php echo $row["id_barang"]; ?>"><?php echo $row["nama_barang"]; ?></option>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div>
                                                    <?php
                                                            $query = mysqli_query($conn, "select id_barang,nama_barang from barang where kode_kategori = '3'");
                                                            ?>
                                                            <select style="background-color: lightgray; color: black; height: 40px; width: 650px;">
                                                            <?php while ($row = mysqli_fetch_array($query)) { ?>    
                                                                <option value="<?php echo $row["id_barang"]; ?>"><?php echo $row["nama_barang"]; ?></option>
                                            ...
                                            <div class="form-group">
                                                <input type="number" placeholder="Harga Barang" class="form-control" name="" id=""  min="1" style="width: 200px;">
                                            </div>	
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <button type="submit" style="width: 140px; height: 50px; border-radius: 50px; background-color: lightgray;">Insert</button>
                                        </div>
                                    </div>
                                    <!-- <div class="card-body border-top">
                                        <h4>Input Sizes</h4>
