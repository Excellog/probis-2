                    ...
                    <div class="col-xl-10">
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="page-header" id="top">
                                    <h2 class="pageheader-title">Form Insert Product Laptop </h2>
                                    ...
                                    <div class="page-breadcrumb">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item active" aria-current="page">Form Insert Product Laptop</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="card">
                                    <h5 class="card-header">Insert Product Laptop</h5>
                                    <div class="card-body">
                                        <div class="form-group">
                                            <table>
                                                <tr>
                                                    ...
                                                    <td><div style="margin-left: 10px;margin-right: 10px;">:</div></td>
                                                    <td>
                                                            <div>
                                                                    <select style="background-color: lightgray; color: black; height: 40px">
                                                                        <option value="processor">Dell</option>
                                                                        <option value="processor">Lenovo</option>
                                                                        <option value="processor">HP</option>
                                                                        <option value="processor">Apple Macbook</option>
                                                                        <option value="processor">MSI</option>
                                                                        <option value="processor">Acer</option>
                                                                    </select>
                                                                </div>
                                                    </td>
                                                </tr>
                                            ...
                                            <div class="input-group mb-3">
                                                <!-- <input type="text" placeholder="Username" class="form-control"> -->
                                                    <input type="text" placeholder="Nama Barang" class="form-control" name="" id="">
                                            </div>
                                            <div class="input-group mb-3">
                                                <!-- <input type="text" placeholder="Username" class="form-control"> -->
                                                <input type="text" placeholder="Detail Barang" class="form-control" name="" id="">
                                            </div>
                                            <div class="input-group mb-3">
                                                <!-- <input type="text" placeholder="Username" class="form-control"> -->
                                                <input type="number" placeholder="Harga Barang" min="10000" step="1000" class="form-control" name="" id="">
                                            </div>
                                            <div class="input-group mb-3">
                                                <!-- <input type="text" placeholder="Username" class="form-control"> -->
                                                <input type="number" placeholder="Stok Barang" min="1" class="form-control" name="" id="">
                                            </div>
                                            <div>
